...
zed-ros2-wrapper 사용 시 필수 규칙. 전체 파라미터/서비스는 `/zed-sdk` 스킬의 `ros2-api-reference.md` 참조.
...
TF 통합 상세: `/zed-sdk` 스킬의 `robot-integration.md` 참조.
...
CPU 과부하: `grab_compute_capping_fps`, `point_cloud_freq` 동적 조절. 해상도: `pub_downscale_factor: 2.0`. 상세: `/zed-sdk` 스킬의 `optimization.md`
